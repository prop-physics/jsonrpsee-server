...
This repository is a narrowly scoped fork of `jsonrpsee-server` 0.23.2. It
adds a per-connection WebSocket extension factory to the server configuration
and builder APIs. Extension negotiation and frame behavior remain owned by
downstream applications.

The source was extracted from the official jsonrpsee 0.23.2 package. For the
upstream project, documentation, and examples, see
